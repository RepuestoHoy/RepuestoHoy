...
export default function GraciasClient() {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola! Acabo de hacer el pedido #${order.id} en RepuestoHoy y quiero coordinar el pago.`
  )
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="card p-6 mb-6 bg-[#25D366]/10 border-[#25D366]">
          <div className="text-center">
            <p className="font-bold text-[#111111] mb-1">📞 Te escribiremos por WhatsApp en los próximos minutos</p>
            <p className="text-sm text-[#2A2A2A] mb-4">para coordinar el pago y la entrega. ¿Prefieres escribirnos tú primero? No hay problema:</p>
            <a
              href={`https://wa.me/${BUSINESS_CONFIG.whatsapp}?text=${whatsappMessage}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#25D366] text-white font-bold rounded-lg hover:bg-[#128C7E] transition-colors"
            >
