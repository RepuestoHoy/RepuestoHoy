...
const CATEGORY_GROUPS = [
  {
    ...
    items: [
      { id: 'frenos', name: 'Frenos', icon: BrakeIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Pastillas, discos' },
      { id: 'filtros', name: 'Filtros', icon: FilterIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Aceite, aire, gasolina' },
      { id: 'bateria', name: 'Batería', icon: BatteryIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Baterías y cables' },
      { id: 'aceites', name: 'Aceites', icon: OilIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Motor, caja' },
      { id: 'bujias', name: 'Bujías', icon: SparkPlugIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Encendido' },
      { id: 'neumaticos', name: 'Neumáticos', icon: TireIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Cauchos' },
      { id: 'parabrisas', name: 'Parabrisas', icon: WiperIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Limpia parabrisas' },
    ]
  },
  {
    title: 'Reparación',
  ...
  },
  {
    ...
    items: [
      { id: 'audio', name: 'Audio', icon: AudioIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Parlantes, radio' },
      { id: 'iluminacion', name: 'Iluminación', icon: LightIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'LED, faros' },
      { id: 'interior', name: 'Interior', icon: InteriorIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Cubreasientos' },
      { id: 'exterior', name: 'Exterior', icon: ExteriorIcon, color: 'from-[#FF6A00] to-[#E55A00]', desc: 'Estribos, spoilers' },
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center p-8">
          <div className="w-20 h-20 mx-auto mb-4 flex items-center justify-center text-[#FF6A00]">
          ...
          <Link href="/" className="bg-[#FF6A00] text-white px-8 py-4 rounded-xl font-bold inline-block">
            Ir al inicio
          </Link>
        </div>
      </div>
  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
            <button 
              ...
              className="bg-[#FF6A00] text-white px-5 py-2 rounded-full text-sm font-bold whitespace-nowrap"
            >
              Ver Todo
            </button>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        {/* Banner de ayuda */}
        <div className="bg-gradient-to-r from-[#FF6A00] to-[#E55A00] rounded-2xl p-6 mb-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a
              ...
              className="bg-white text-[#FF6A00] px-6 py-3 rounded-xl font-bold hover:bg-gray-100 transition-colors whitespace-nowrap"
            >
              Consultar ahora
            </a>
          </div>
        ...
        <div className="mb-8">
          <div className="relative max-w-xl mx-auto">
            <input
              ...
              className="w-full px-5 py-4 pl-12 bg-white border-2 border-gray-200 rounded-2xl text-[#111111] placeholder-gray-400 focus:outline-none focus:border-[#FF6A00] transition-colors text-lg"
            />
            <svg 
      ...
      <Suspense fallback={
        <div className="min-h-screen bg-white flex items-center justify-center">
          <div className="text-center">
            <div className="w-10 h-10 border-4 border-[#FF6A00] border-t-transparent rounded-full animate-spin mx-auto"></div>
